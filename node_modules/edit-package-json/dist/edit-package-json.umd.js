...
\r`.includes(e[r])||i&&e[r]===M))return r;return null}function P(e,t=0){return vr({str:e,idx:t,stopAtNewlines:!1,stopAtRawNbsp:!1})}function At(e,t,n,i,r){if(typeof t!="string"||!t.length||(typeof n!="number"&&(n=0),e==="right"&&!t[n+1]||e==="left"&&!t[~-n]))return null;let u=n,a=[],s,m,o,l=0;for(;l<r.length;){if(!Se(r[l])||!r[l].length){l+=1;continue}let{value:c,optional:y,hungry:g}=Or(r[l]),f=e==="right"?C(t,u):P(t,u);if(i.i&&t[f].toLowerCase()===c.toLowerCase()||!i.i&&t[f]===c){let d=e==="right"?C(t,f):P(t,f);g&&(i.i&&t[d].toLowerCase()===c.toLowerCase()||!i.i&&t[d]===c)?o=!0:l+=1,typeof f=="number"&&e==="right"&&f>u+1?a.push([u+1,f]):e==="left"&&typeof f=="number"&&f<~-u&&a.unshift([f+1,u]),u=f,e==="right"?(s===void 0&&(s=f),m=f):(m===void 0&&(m=f),s=f)}else if(y){l+=1;continue}else if(o){l+=1,o=void 0;continue}else return null}return s===void 0||m===void 0?null:{gaps:a,leftmostChar:s,rightmostChar:m}}var ue={i:!1};function jr(e,t,...n){if(!(n!=null&&n.length))throw new Error("string-left-right/leftSeq(): only two input arguments were passed! Did you intend to use left() method instead?");let i;return(0,Y.default)(n[0])?i=S(S({},ue),n.shift()):i=ue,At("left",e,t,i,Array.from(n).reverse())}function Nr(e,t,...n){if(!(n!=null&&n.length))throw new Error("string-left-right/rightSeq(): only two input arguments were passed! Did you intend to use right() method instead?");let i;return(0,Y.default)(n[0])?i=S(S({},ue),n.shift()):i=ue,At("right",e,t,i,n)}function we(e,t,n,i,r=[]){var m;if(typeof t!="string"||!t.length||((!n||typeof n!="number")&&(n=0),e==="right"&&!t[n+1]||e==="left"&&+n==0))return null;let u=null,a=null;do u=e==="right"?Nr(t,typeof a=="number"?a:n,...r):jr(t,typeof a=="number"?a:n,...r),u!==null&&(a=e==="right"?u.rightmostChar:u.leftmostChar);while(u);if(a!=null&&e==="right"&&(a+=1),a===null)return null;if(e==="right"){if((m=t[a])!=null&&m.trim())return a;let o=C(t,a);if(!i||i.mode===0){if(o===a+1)return a;if(t.slice(a,o||t.length).trim()||t.slice(a,o||t.length).includes(`
